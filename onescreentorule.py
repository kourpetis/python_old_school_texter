...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Label1.place(relx=0.262, rely=0.024, height=41, width=284)
        ...
        self.Label2.place(relx=0.093, rely=0.145, height=91, width=194)
        self.Label2.configure(background="#d9d9d9")
        self.Label2.configure(disabledforeground="#a3a3a3")
        self.Label2.configure(foreground="#000000")
        self.Label2.configure(text='''Sensor_1 values''')
        self.Label2.configure(width=194)

        self.Label3 = tk.Label(self.Frame1)
        self.Label3.place(relx=0.617, rely=0.145, height=91, width=164)
        self.Label3.configure(background="#d9d9d9")
        self.Label3.configure(disabledforeground="#a3a3a3")
        self.Label3.configure(foreground="#000000")
        self.Label3.configure(text='''Sensor_3 values''')
        self.Label3.configure(width=164)

        self.Label4 = tk.Label(self.Frame1)
        self.Label4.place(relx=0.131, rely=0.337, height=91, width=164)
        self.Label4.configure(background="#d9d9d9")
        self.Label4.configure(disabledforeground="#a3a3a3")
        self.Label4.configure(foreground="#000000")
        self.Label4.configure(text='''Sensor_2 values''')
        self.Label4.configure(width=164)

        self.Label5 = tk.Label(self.Frame1)
        self.Label5.place(relx=0.617, rely=0.337, height=91, width=154)
        self.Label5.configure(background="#d9d9d9")
        self.Label5.configure(disabledforeground="#a3a3a3")
        self.Label5.configure(foreground="#000000")
        self.Label5.configure(text='''Sensor_4 Values''')
        ...
        self.Button3.configure(command=lambda: open_chart_sensor4())
        ...
        self.Button4.configure(command=lambda: open_chart_sensor1())
