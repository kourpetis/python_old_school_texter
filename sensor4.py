...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Label2.configure(text='''Sensor_4 values''')
        ...
        self.Label5.configure(text='''Sensor_3''')
        ...
        self.Button3.configure(command=lambda: open_chart_sensor3())
        ...
        self.Button4.configure(command=lambda: open_sensor_reading()) 
